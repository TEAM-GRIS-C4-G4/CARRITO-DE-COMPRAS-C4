...
export default {
    ...
    methods: {
        loadData: function () {
            axios.get('http://150.136.125.111:8080/api/roles').then(result => {
        ...
        findByid: function (id) {
            ...
            axios.get('http://150.136.125.111:8080/api/roles/' + id).then(result => {
            ...
            if (bandera == true) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete('http://150.136.125.111:8080/api/roles/' + id).then(() => {
                            Swal.fire({
                                icon: 'success',
        ...
        dataAdd: function () {
            ...
            axios.post('http://150.136.125.111:8080/api/roles', data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
        ...
        dataUpdate: function () {
            ...
            axios.put('http://150.136.125.111:8080/api/roles/' + this.id, data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
                        title: "'El registro se guardó de forma correcta.'",
