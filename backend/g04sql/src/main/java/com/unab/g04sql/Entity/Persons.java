...
public class Persons {
	...
	@Column(name = "tipo_documento", nullable = false, unique = false, length = 10)
    private String tipoDocumento;
	
	@Column(name = "documento", nullable = false, unique = true, length = 20)
    private String documento;
	
	@Column(name = "primer_nombre", nullable = false, unique = false, length = 20)
    private String primerNombre;
	
	@Column(name = "segundo_nombre", nullable = true, unique = false, length = 20)
    private String segundoNombre;
	
	@Column(name = "primer_apellido", nullable = false, unique = false, length = 20)
    private String primerApellido;
	
	@Column(name = "segundo_apellido", nullable = true, unique = false, length = 20)
