...
public class ProductsController {
	...
	public Products update(@PathVariable Integer id, @RequestBody Products products) {
		...
		if (!op.isEmpty()) {
			...
			productsUpdate.setPrecioUnitarioCompra(products.getPrecioUnitarioCompra());
			productsUpdate.setPrecioUnitarioVenta(products.getPrecioUnitarioVenta());
			productsUpdate.setIva(products.getIva());
			productsUpdate.setDescuento(products.getDescuento());
			productsUpdate.setCategoriaId(products.getCategoriaId());
			productsUpdate.setMarcaId(products.getMarcaId());
			productsUpdate.setUnidadMedidaId(products.getUnidadMedidaId());
